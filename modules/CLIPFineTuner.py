...
class CLIPFineTuner(nn.Module):
    ...
    def forward(self, text_input_ids, attention_mask, video_frames, video_mask):
        ...
        similarity_matrix = self.compute_similarity_matrix(text_features, video_features, video_mask)
        loss_text_to_video = self.loss_function(similarity_matrix)
        loss_video_to_text = self.loss_function(similarity_matrix.T)
