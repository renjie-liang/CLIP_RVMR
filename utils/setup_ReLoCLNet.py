...
def get_args():
    ...
    parser.add_argument("--batch_size_eval", type=int, default=16, help="mini-batch size")
    ...
    parser.add_argument("--max_qlen", type=int, default=30, help="max length of descriptions")
    parser.add_argument("--max_vlen", type=int, default=128, help="max number of snippets, 100 for tvr clip_length=1.5, oly 109/21825 > 100")
